...
const static uint64_t system_account_name    = N(BE);
const static uint64_t null_account_name      = N(BE.null);
const static uint64_t producers_account_name = N(BE.prods);
...
const static uint64_t eosio_auth_scope       = N(BE.auth);
const static uint64_t eosio_all_scope        = N(BE.all);

const static uint64_t active_name = N(active);
const static uint64_t owner_name  = N(owner);
const static uint64_t eosio_any_name = N(BE.any);
const static uint64_t eosio_code_name = N(BE.code);
