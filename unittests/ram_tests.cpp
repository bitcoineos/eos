...
BOOST_FIXTURE_TEST_CASE(ram_tests, eosio_system::eosio_system_tester) { try {
   ...
   buyrambytes(N(BE), N(BE), 70000);
   produce_blocks(10);
   create_account_with_resources(N(testram11111),N(BE), init_request_bytes + 40);
   create_account_with_resources(N(testram22222),N(BE), init_request_bytes + 1190);
   produce_blocks(10);
   BOOST_REQUIRE_EQUAL( success(), stake( "BE.stake", "testram11111", core_from_string("10.0000"), core_from_string("5.0000") ) );
   produce_blocks(10);
   ...
   for (auto i = 0; i < 10; ++i) {
      try {
         ...
         buyrambytes(N(BE), N(testram11111), increment_contract_bytes);
         buyrambytes(N(BE), N(testram22222), increment_contract_bytes);
      }
   }
   produce_blocks(10);
   ...
   buyrambytes(N(BE), N(testram11111), more_ram);
   buyrambytes(N(BE), N(testram22222), more_ram);
